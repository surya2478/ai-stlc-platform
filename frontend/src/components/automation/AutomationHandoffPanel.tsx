    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2">
          <select
            ...
            className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#1b59f8] disabled:bg-slate-50 disabled:text-slate-400"
          >
      ...
      {awaitingClassificationApproval ? (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
          <p className="text-xs font-extrabold text-blue-900">Manual until the classification is approved</p>
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          <p className="text-xs font-extrabold text-slate-700">Manual test case</p>
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          <p className="text-xs font-extrabold text-slate-700">Approve this test case first</p>
          <p className="mt-1 text-[11px] font-semibold leading-5 text-slate-600">
