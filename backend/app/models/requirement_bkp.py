from sqlalchemy import Boolean, DateTime, ForeignKey, String, Text, Float, UniqueConstraint, ARRAY
...
class Requirement(TimestampMixin, Base):
    ...
    # QA Domain & Classification fields
    ...
    regulatory_impact: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    revenue_impact: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    customer_impact: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    ...
    readiness_status: Mapped[str | None] = mapped_column(String(50), nullable=True, index=True)

    # Optional Jira fields & enrichment fields
    ...
    jira_issue_id: Mapped[str | None] = mapped_column(String(100), nullable=True, unique=True)
