...
class TestData(TimestampMixin, Base):
    ...
    privacy_level: Mapped[str | None] = mapped_column(String(50), nullable=True)
    contains_pii: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    masking_status: Mapped[str | None] = mapped_column(String(50), nullable=True)
    synthetic_generation_status: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    jira_sync_status: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    actual_record_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
